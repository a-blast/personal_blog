...
The ability to speak intelligently about all of these prompts with your colleagues will not only make you a more effective developer, but will also inevitably lead to better & more maintainable products/services as you learn how to best fit your piece of the puzzle in with those of the team that may have been built 10 years ago, 20 years in the future, or any other point in between (shout out to the democratization of knowledge 🐝) The goal of this mini-series is to go over my approach & methodology to building a micro service-based data feature that we are using at [Atomata](https://growatomata.com) today, for work with time series data streams to optimize indoor environments for cannabis cultivation.  
